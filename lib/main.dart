  ...
  Widget build(BuildContext context) {
    return MaterialApp.router(
      ...
      theme: ThemeData(
        ...
        routerConfig: appRouter//Page6Desktop()//Page5Desktop()//Page4Desktop()//Page3Desktop()//PortfolioApp()//Page1screen()//Staclclass()//MediaScreen()//Page1screen()//Mainscreen()//HomeScreen1()//const MyHomePage(title: 'Flutter Demo Home Page'),
    );
  }
}
