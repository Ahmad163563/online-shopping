...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Page7Desktop()//Page6Desktop()//Page5Desktop()//Page4Desktop()//Page3Desktop()//PortfolioApp()//Page1screen()//Staclclass()//MediaScreen()//Page1screen()//Mainscreen()//HomeScreen1()//const MyHomePage(title: 'Flutter Demo Home Page'),
    );
  }
}
